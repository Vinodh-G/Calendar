...
class DateFormatter_Util_Tests: XCTestCase {
    ...
    func testTimeStringFor01_00() {
        ...
        XCTAssertEqual(DateFormatter.shared.timeStringFor(date: date), "01:00")
    }
    ...
    func testTimeStringFor14_35() {
        ...
        date = Calendar.current.date(from: components)!
        XCTAssertEqual(DateFormatter.shared.timeStringFor(date: date), "14:35")
    }
    ...
    func testTimeStringFor24_00() {
        ...
        date = Calendar.current.date(from: components)!
        XCTAssertEqual(DateFormatter.shared.timeStringFor(date: date), "00:00")
    }
    ...
    func testTimeStringFor23_59() {
        ...
        date = Calendar.current.date(from: components)!
        XCTAssertEqual(DateFormatter.shared.timeStringFor(date: date), "23:59")
    }

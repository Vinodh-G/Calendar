...
class AgendaViewConfig {
    ...
    public var eventTitleFont: UIFont = UIFont.systemFont(ofSize: 16, weight: .bold)
    
    public var eventDetailTitleColor = UIColor.black
    ...
    public var endTimeLabelColor = UIColor.black
